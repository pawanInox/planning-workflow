...
export interface ProjectsService {
  createProject(data: { title: string; tasks: NewTask[] }): Promise<ProjectWithTasks>
  listProjects(): Promise<ProjectSummary[]>
  getProject(id: string): Promise<ProjectWithTasks>
  updateProject(id: string, data: { title?: string; tasks?: NewTask[] }): Promise<ProjectWithTasks>
