...
import { addTaskSchema, createProjectSchema, listProjectsSchema, patchTaskSchema, updateProjectSchema } from '../../schemas/projects.schema.ts'
...
export function projectsRoutes(controller: ReturnType<typeof makeProjectsController>): Router {
  ...
  r.get('/', validate(listProjectsSchema), controller.list)
